        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="reveal-left">
            ...
            <h2 className="text-4xl sm:text-5xl font-[family-name:var(--font-instrument)] tracking-tight text-white leading-tight">
              Somos uma empresa
              <br />
              de <span className="text-gradient italic">tecnologia</span>
            </h2>
            <div className="mt-8 space-y-6">
              <p className="text-sm font-light text-white/50 leading-relaxed">
                A FYRE Automação & I.A constrói{" "}
                <span className="text-white font-medium">
                  sistemas inteligentes para escalar negócios
                </span>
                . Você não contrata serviços avulsos. Você contrata um sistema
                que automatiza seu atendimento, qualifica seus leads e faz sua
                operação comercial rodar sozinha.
              </p>
              <p className="text-sm font-light text-white/50 leading-relaxed">
                Transformamos seu negócio em uma{" "}
                <span className="text-white font-medium">
                  máquina previsível de vendas
                </span>
                . Automação, I.A. e sistemas sob medida — tudo conectado
                para você escalar sem aumentar custo operacional.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: "Soluções sob medida para a sua operação",
              },
              {
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
                ...
                desc: "Cada sistema é projetado com estratégia de negócio",
              },
              {
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
                ...
                title: "Automação & I.A.",
                desc: "Processos inteligentes que funcionam 24h",
              },
              {
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
                ...
                title: "Escala & Resultado",
                desc: "Crescimento previsível com sistemas inteligentes",
              },
            ].map((feature) => (
              <div key={feature.title} className="glass-card p-6 rounded-2xl group">
                <div className="w-10 h-10 rounded-xl border border-white/10 flex items-center justify-center text-white/30 mb-4 group-hover:text-white/60 group-hover:border-white/20 transition-all duration-500">
                  {feature.icon}
                </div>
