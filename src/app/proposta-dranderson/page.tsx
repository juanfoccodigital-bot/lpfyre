...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "investimento_trafego", label: "Investem em trafego pago? Quanto e em quais plataformas?", type: "text", required: false },
...
const INCLUDED = [
  ...
  { label: "Dashboard de Metricas", desc: "Acompanhe leads, conversoes, agendamentos e mais em tempo real" },
];

export default function PropostaDrAnderson() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    for (const file of Array.from(e.target.files)) {
      const result = await uploadOnboardingFile(file, "dranderson");
  ...
  const handleSubmit = async () => {
    ...
    try {
      await createOnboardingBriefing({
        cliente_nome: formData.nome_responsavel || "Dr. Anderson",
        cliente_empresa: formData.nome_fantasia || "Clinica Dr. Anderson",
        cliente_email: formData.email || "",
        cliente_whatsapp: formData.whatsapp || "",
        proposta_ref: "dranderson",
        respostas: formData,
        arquivos: files,
        status: "pendente",
      });
    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden" ref={topRef}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8">
        ...
        <div className="py-16 sm:py-24 text-center border-b border-white/5 reveal">
            ...
            <div className="relative w-24 h-24">
              <svg className="absolute inset-0 w-full h-full animate-[spin_12s_linear_infinite]" viewBox="0 0 100 100">
                ...
                <text className="fill-white/30" style={{ fontSize: "7.5px", letterSpacing: "3px", fontFamily: "var(--font-montserrat)", fontWeight: 600, textTransform: "uppercase" }}>
                  <textPath href="#cpHero">CLINPRO BY FYRE • CLINPRO BY FYRE • </textPath>
                </text>
              </svg>
          ...
          <span className="text-[10px] font-semibold tracking-[0.3em] uppercase text-[#00FF2B]/60 block mb-4">ClinPro</span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-instrument)] tracking-tight leading-tight">
            Sua clinica no <br />
            <span className="text-gradient-fyre italic">piloto automatico</span>
          </h1>
          <p className="text-sm sm:text-base font-light text-white/35 mt-6 max-w-xl mx-auto leading-relaxed">
            Agentes de inteligencia artificial que atendem, qualificam, acompanham e confirmam seus pacientes.
        ...
        <div className="py-14 sm:py-20 border-b border-white/5">
          ...
          <div className="glass-card-glow rounded-2xl p-8 sm:p-10 text-center reveal animate-pulse-glow">
            <span className="text-[10px] font-semibold tracking-[0.3em] uppercase text-[#00FF2B]/60 block mb-4">ClinPro Mensal</span>
            <div className="flex items-baseline justify-center gap-1">
              <span className="text-white/30 text-lg font-light">R$</span>
              <span className="text-5xl sm:text-6xl md:text-7xl font-black text-white">1.297</span>
            ...
            <p className="text-xs font-light text-white/40 max-w-md mx-auto leading-relaxed">
              Inclui todos os 5 agentes de I.A, sistema ClinPro completo, R$300 em tokens, suporte, grupo exclusivo e atualizacoes continuas.
            </p>
        ...
        <div className="py-14 sm:py-20 border-b border-white/5">
          ...
          <div className="space-y-3">
            {[
              { title: "Construimos sistema, nao vendemos pacote.", desc: "Cada agente e treinado especificamente para o seu negocio. Nada generico." },
              { title: "Voce fica com o ativo.", desc: "Se encerrar, toda a estrutura fica com voce. Zero dependencia." },
              { title: "Resultados mensuraveis.", desc: "Dashboard com metricas reais: leads atendidos, tempo de resposta, conversoes." },
              { title: "Suporte humano real.", desc: "Equipe FYRE disponivel para ajustes, duvidas e otimizacoes constantes." },
              { title: "Velocidade de entrega.", desc: "Agentes configurados e no ar em ate 10 dias uteis apos o briefing." },
            ].map((d, i) => (
        ...
        {showOnboarding && (
          <div ref={formRef} className="py-14 sm:py-20 border-b border-white/5">
            ...
            <h2 className="text-2xl sm:text-3xl font-[family-name:var(--font-instrument)] tracking-tight text-white mb-3">
              Vamos construir seus <span className="text-gradient-fyre italic">agentes</span>
            </h2>
            <p className="text-xs font-light text-white/35 mb-8 max-w-lg leading-relaxed">
              Preencha com calma e atencao. Cada resposta sera usada diretamente na programacao e treinamento dos seus agentes de I.A.
            </p>
            ...
            {submitted ? (
              <div className="glass-card-glow rounded-2xl p-8 sm:p-12 text-center">
                ...
                <p className="text-xs font-light text-white/40 max-w-sm mx-auto">
                  A equipe FYRE ja recebeu suas informacoes e vai comecar a construcao dos seus agentes.
                  ...
                  {isLastStep && (
                    <div className="mt-6 pt-6 border-t border-white/5">
                      <label className="block text-[11px] font-medium text-white/50 mb-3">
                        Anexar arquivos (catalogos, tabelas, fotos, documentos)
                      </label>
